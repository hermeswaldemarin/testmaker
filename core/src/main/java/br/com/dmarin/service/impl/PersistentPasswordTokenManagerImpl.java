...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see br.com.dmarin.service.impl.PasswordTokenManager#generateRecoveryToken(br.com.dmarin.model.User)
     */
    @Override
    ...
    /**
     * @see br.com.dmarin.service.impl.PasswordTokenManager#isRecoveryTokenValid(br.com.dmarin.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see br.com.dmarin.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
