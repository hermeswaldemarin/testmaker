...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see br.com.dmarin.testmaker.service.impl.PasswordTokenManager#generateRecoveryToken(br.com.dmarin.testmaker.model.User)
     */
    @Override
    ...
    /**
     * @see br.com.dmarin.testmaker.service.impl.PasswordTokenManager#isRecoveryTokenValid(br.com.dmarin.testmaker.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see br.com.dmarin.testmaker.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
